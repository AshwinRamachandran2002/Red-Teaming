...
def get_completion(model, tokenizer, suffix_manager, adv_suffix, device):
    ...
    for i in range(num_steps):
        ...
        with torch.no_grad():
            ...
            logits, ids = get_logits(
                ...
                test_controls=new_adv_suffix, return_ids=True,
                batch_size=512
        ...
        get_completion(model, tokenizer, suffix_manager, adv_suffix, device)
